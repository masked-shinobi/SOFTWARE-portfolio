...
-- Description: Seeding profile, 18 projects, and 29 skills for Sanjay Baskar
...
(
  ...
  'portfolio/projects/ai-resume-analyzer/thumbnail.png',
  ARRAY['portfolio/projects/ai-resume-analyzer/screenshot-1.png'],
  true, true, 1
),
(
  ...
  'portfolio/projects/advanced-rag-resembler/thumbnail.png',
  ARRAY['portfolio/projects/advanced-rag-resembler/screenshot-1.png'],
  true, true, 2
),
(
  'RAG Architecture',
  ...
  'portfolio/projects/rag-architecture/thumbnail.png',
  ARRAY['portfolio/projects/rag-architecture/screenshot-1.png'],
  false, true, 3
),
(
  'MCQ Master',
  ...
  'portfolio/projects/mcq-master/thumbnail.png',
  ARRAY['portfolio/projects/mcq-master/screenshot-1.png'],
  true, true, 4
),
(
  ...
  'https://marketplace.visualstudio.com/items?itemName=SanjayBaskar.shinobi-black-theme',
  'portfolio/projects/shinobi-black-theme/thumbnail.png',
  ARRAY['portfolio/projects/shinobi-black-theme/screenshot-1.png'],
  true, true, 5
),
(
  ...
  'portfolio/projects/cybersecurity-web-centinel/thumbnail.png',
  ARRAY['portfolio/projects/cybersecurity-web-centinel/screenshot-1.png'],
  false, true, 6
),
(
  'GSAP 3D Website',
  ...
  'portfolio/projects/gsap-3d-website/thumbnail.png',
  ARRAY['portfolio/projects/gsap-3d-website/screenshot-1.png'],
  false, true, 7
),
(
  'Ecommerce Devin',
  ...
  'portfolio/projects/ecommerce-devin/thumbnail.png',
  ARRAY['portfolio/projects/ecommerce-devin/screenshot-1.png'],
  false, true, 8
),
(
  'DevOps WebApp Cloud',
  ...
  'portfolio/projects/devops-webapp-cloud/thumbnail.png',
  ARRAY['portfolio/projects/devops-webapp-cloud/screenshot-1.png'],
  true, true, 9
),
(
  'Tic Tac Toe Docker',
  ...
  'portfolio/projects/tic-tac-toe-docker/thumbnail.png',
  ARRAY['portfolio/projects/tic-tac-toe-docker/screenshot-1.png'],
  false, true, 10
),
(
  'Food Delivery App',
  ...
  'portfolio/projects/food-delivery-app/thumbnail.png',
  ARRAY['portfolio/projects/food-delivery-app/screenshot-1.png'],
  true, true, 11
),
(
  ...
  'portfolio/projects/android-file-manager/thumbnail.png',
  ARRAY['portfolio/projects/android-file-manager/screenshot-1.png'],
  false, true, 12
),
(
  ...
  'portfolio/projects/organ-donation-platform/thumbnail.png',
  ARRAY['portfolio/projects/organ-donation-platform/screenshot-1.png'],
  true, true, 13
),
(
  'Email Simulator',
  ...
  'portfolio/projects/email-simulator/thumbnail.png',
  ARRAY['portfolio/projects/email-simulator/screenshot-1.png'],
  false, true, 14
),
(
  'DSA in C++',
  ...
  'portfolio/projects/dsa-in-cpp/thumbnail.png',
  ARRAY['portfolio/projects/dsa-in-cpp/screenshot-1.png'],
  false, true, 15
),
(
  'PTS Algorithm',
  ...
  'portfolio/projects/pts-algorithm/thumbnail.png',
  ARRAY['portfolio/projects/pts-algorithm/screenshot-1.png'],
  false, true, 16
),
(
  'Python Unit Testing',
  ...
  'portfolio/projects/python-unit-testing/thumbnail.png',
  ARRAY['portfolio/projects/python-unit-testing/screenshot-1.png'],
  false, true, 17
),
(
  ...
  'portfolio/projects/srm-placement-compass/thumbnail.png',
  ARRAY['portfolio/projects/srm-placement-compass/screenshot-1.png'],
  false, true, 18
)
